...
const pricing = () => {
  ...
  <div class="container px-5 py-24 mx-auto">
    <div class="flex flex-col text-center w-full mb-20">
      ...
      <p class="lg:w-2/3 mx-auto leading-relaxed text-base">The Premium Plan offers a number of benefits over the Free Plan. For a limited time, new Premium Plan subscribers can get their first month for free.
      You can cancel your Premium Plan at any time. There is no contract. </p>
    </div>
    ...
    <div class="flex pl-4 mt-4 lg:w-2/3 w-full mx-auto">
      ...
      <button class="flex ml-auto text-white bg-indigo-500 border-0 py-2 px-6 focus:outline-none hover:bg-indigo-600 rounded">Apply</button>
    </div>
  </div>
</section>
    </>
